...
const CoffeeShopLayout = ({ children }) => {
        ...
        <div className="min-h-screen flex flex-col bg-[#E9EFEC] text-[#16423C] relative">
            ...
            <header className="bg-[#16423C] text-[#E9EFEC] p-4 sm:p-6 px-4 sm:px-10 shadow-md relative z-20">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    {/* Center Logo */}
                    <Link to="/l" className="flex items-center justify-center mx-auto md:mx-8 transform hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="flex justify-between max-sm:justify-end items-center space-x-4 flex-1">
                        ...
                        <div className="relative hidden md:flex" ref={userMenuRef}>
                            <Link to="/library" className="hover:text-[#6A9C89] mx-1 transition duration-300 transform hover:scale-105">
                                <Book className="inline-block" size={20} />
                            </Link>
                            ...
                            {isUserMenuOpen && (
                                <div className="absolute right-0 top-5 mt-2 w-48 bg-[#16423C] rounded-md shadow-lg py-1 z-30 animate-fadeIn">
                                    <Link to="/settings" className="block px-4 py-2 text-sm hover:bg-[#6A9C89] hover:text-[#E9EFEC]">Settings</Link>
                                    <Link to="/dcv" className="block px-4 py-2 text-sm hover:bg-[#6A9C89] hover:text-[#E9EFEC]">DCV</Link>
